...
import cn.nuaa.dmrfcoder.androidexceldemo.AppContext;
...
public class SpUtil {
    ...
    private SpUtil() {
        mSharedPreferences = AppContext.sInstance.getSharedPreferences("SharedPreferences", Context.MODE_MULTI_PROCESS);
    }
